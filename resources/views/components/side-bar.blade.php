<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white shadow-sm"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" # " target="_blank">
            <span class="ms-1 font-weight-bold text-uppercase">IISMEE</span> <br/>
            <span class="ms-1 font-weight-bold text-uppercase">Role : {{ auth()->user()->level }}</span>
        </a>
    </div>
    <hr class="horizontal text-dark mt-0">
    <div class="collapse navbar-collapse  w-auto py-2" id="sidenav-collapse-main" style="height: auto !important">
        <ul class="navbar-nav">
