                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon3">{{ __('messages.start_date') }} {{ __('messages.to') }} {{ __('messages.end_date') }}</span>
                                    <input type="text" class="form-control ps-3" id="basic-url"
                                        aria-describedby="basic-addon3 basic-addon4"
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <h6>{{ __('messages.assessment_form') }}</h6>
            </div>
                    ...
                    <table class="table align-items-center mb-0" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-m font-weight-bolder opacity-7">
                                    {{ __('messages.lecturer_id_number') }}
                                </th>
                                <th class="text-uppercase text-secondary text-m font-weight-bolder opacity-7">
